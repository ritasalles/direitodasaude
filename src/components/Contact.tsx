...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Usando a API interna para maior segurança e controle total da entrega
      ...
      if (response.ok) {
        ...
        // Feedback visual de sucesso por 10 segundos para garantir leitura
            ...
            {status === 'success' && (
              <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-start gap-3 animate-in fade-in slide-in-from-top-2">
                ...
                <div>
                  ...
                  <p className="text-green-700 text-sm mt-1">Confirmamos o recebimento. Você receberá um e-mail de confirmação em instantes.</p>
                </div>
              </div>
            )}
